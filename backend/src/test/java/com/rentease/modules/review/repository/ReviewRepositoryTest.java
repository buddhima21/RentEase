...
class ReviewRepositoryTest {
    ...
    @Test
    void findByPropertyIdInAndDeletedFalse() {
        List<Review> results = reviewRepository.findByPropertyIdInAndDeletedFalse(List.of("prop1", "prop2"));
        // results should contain review1 and review2 (prop1), and exclude review3 (prop2, but deleted)
        assertEquals(2, results.size());
        assertTrue(results.stream().allMatch(r -> r.getPropertyId().equals("prop1")));
    }
