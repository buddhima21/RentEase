                ...
                <div className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
                    ...
                    <MaintenanceSectionCard eyebrow="Schedule" title={`Visits on ${selectedDate}`} description="Review the selected date and schedule a new visit if needed.">
                        ...
                        <div className="flex flex-wrap gap-2">
                            ...
                            <input className="rounded-xl border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-900 p-3" type="datetime-local" min={minScheduleTime} value={scheduledAt} onChange={(e) => setScheduledAt(e.target.value)} />
                            <input className="rounded-xl border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-900 p-3" placeholder="Admin note" maxLength={1000} value={notes} onChange={(e) => setNotes(e.target.value)} />
