                ...
                <div className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
                    ...
                    <MaintenanceSectionCard eyebrow="Schedule" title={`Visits on ${selectedDate}`} description="Review the selected date and schedule a new visit if needed.">
                        <div className="flex flex-wrap gap-2">
                            ...
                            <input className="rounded-xl border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-900 p-3" type="datetime-local" value={scheduledAt} onChange={(e) => setScheduledAt(e.target.value)} />
                            <input className="rounded-xl border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-900 p-3" placeholder="Admin note" value={notes} onChange={(e) => setNotes(e.target.value)} />
                                ...
                                <div key={item.id} className="rounded-3xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 p-4">
                                    <div className="flex items-start justify-between gap-3">
                                        <div>
                                            ...
                                            <p className="text-sm text-slate-600 dark:text-slate-300">Technician: {item.assignedTechnicianId || "Unassigned"}</p>
                                        </div>
