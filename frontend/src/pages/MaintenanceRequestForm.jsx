                ...
                >
                    ...
                    <form className="mt-8 space-y-4" onSubmit={submit}>
                        ...
                        {!isEmergencyPriority(form.priority) ? (
                            <div className="grid gap-4 md:grid-cols-2">
                                <input className="w-full rounded-xl border border-slate-300 p-3" type="date" aria-label="Preferred date" value={form.preferredDate} onChange={(e) => setForm({ ...form, preferredDate: e.target.value })} />
