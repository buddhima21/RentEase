    ...
    return (
        <header className="relative flex items-center justify-between border-b border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 px-6 py-3 shrink-0 z-20">
            ...
            <div className="flex items-center gap-8 z-10">
                ...
                {showSearch && (
                    <div className="hidden md:flex items-center border border-slate-200 dark:border-slate-700 rounded-xl bg-slate-50 dark:bg-slate-800/50 px-3 py-1.5 w-80">
            ...
            <div className="flex items-center gap-6 z-10">
                ...
                {user ? (
                    ...
                    <div className="flex items-center gap-3">
                        <Link
                            to="/login"
                            className="px-5 py-2 rounded-xl text-sm font-semibold text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:bg-slate-800/50 transition-all"
                        >
                            Log In
                        </Link>
                        <Link
