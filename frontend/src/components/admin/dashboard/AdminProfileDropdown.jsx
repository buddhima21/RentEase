    ...
    return (
        <div className="relative" ref={dropdownRef}>
            <button
                ...
                className="flex items-center gap-2 p-1.5 rounded-full hover:bg-slate-100 dark:bg-slate-800 transition-colors border border-transparent hover:border-slate-200 dark:border-slate-700 outline-none focus:ring-2 focus:ring-[#26C289]/20"
            >
                <img
                    src={avatarUrl}
            ...
            {open && (
                <div className="absolute right-0 top-full mt-2 w-56 bg-white dark:bg-slate-900 rounded-xl shadow-xl ring-1 ring-black/5 border border-slate-100 dark:border-slate-700/50 py-1 z-50 animate-in fade-in zoom-in-95 duration-100 origin-top-right">
                    ...
                    <div className="py-1">
                        <Link
                            to="/admin/profile"
                            className="flex items-center gap-3 px-4 py-2.5 text-sm text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:bg-slate-800/50 transition-colors"
