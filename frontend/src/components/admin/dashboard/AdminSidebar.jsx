...
/**
 * AdminSidebar — Modern glassmorphism sidebar with smooth transitions.
 * Features Framer-Motion layoutId active tab tracking.
 */
            ...
            <div className="px-6 py-6 border-b border-slate-100/80">
                <Link to="/" className="flex items-center gap-3 group">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] text-emerald-600 font-bold uppercase tracking-[0.2em] mt-1">Admin Portal</p>
                    </div>
                </Link>
            </div>
