    ...
    <div className="min-h-screen bg-slate-950 p-6 sm:p-10 font-sans text-slate-100 selection:bg-blue-500/30">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <StatCard title="Total Rent Collected" value="$124,500" icon={DollarSign} trend="+12.5%" delay={0.1} />
          <StatCard title="Average Rating" value="4.8/5.0" icon={Star} trend="+0.2" delay={0.2} />
          <StatCard title="Active Tenants" value="842" icon={Users} trend="+5.4%" delay={0.3} />
        </div>
