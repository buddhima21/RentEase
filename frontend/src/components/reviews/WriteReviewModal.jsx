      ...
      <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-md flex items-center justify-center z-50 p-4">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <textarea
              className="border border-slate-200 bg-white/50 backdrop-blur-sm rounded-xl p-4 min-h-[120px] resize-y focus:outline-none focus:ring-4 focus:ring-[#0d9488]/20 focus:border-[#0d9488] transition-all duration-300"
            ...
            <div className="flex gap-2 justify-end mt-2">
              ...
              <button
                type="submit"
                className="px-6 py-2.5 rounded-xl bg-gradient-to-r from-[#0d9488] to-[#115e59] text-white font-bold hover:shadow-[0_4px_15px_rgba(13,148,136,0.4)] hover:-translate-y-0.5 transition-all duration-300 disabled:opacity-50 disabled:hover:translate-y-0 disabled:hover:shadow-none"
