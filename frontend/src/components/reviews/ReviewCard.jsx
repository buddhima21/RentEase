...
export default function ReviewCard({ review, onEdit, onDelete }) {
    ...
    return (
        ...
        >
            ...
            <div className="flex flex-row flex-wrap justify-between items-start gap-4 mb-5 w-full">
                    ...
                    <div className="flex flex-col justify-center">
                        <div className="flex items-center gap-2">
                            ...
                            {review.status === 'PENDING' && (
                                <span className="inline-flex items-center text-[10px] bg-amber-100/80 text-amber-700 px-2.5 py-0.5 rounded-full font-bold uppercase tracking-wider">
                ...
                <div className="flex items-center gap-3 self-start mt-2">
                    ...
                    {user && user.id && review.reviewerId && user.id === review.reviewerId && !isDeleting && (
