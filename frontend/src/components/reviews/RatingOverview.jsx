export default function RatingOverview({ rating, totalReviews }) {
    ...
    return (
        <div className="relative overflow-hidden p-6 sm:p-8 rounded-[2rem] border border-white/60 bg-white/40 backdrop-blur-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] h-full flex flex-col justify-center">
            {/* Glowing orb background effect */}
            <div className="absolute -top-24 -right-24 w-48 h-48 bg-[#f59e0b]/20 rounded-full blur-3xl pointer-events-none"></div>

            <div className="text-center mb-8 relative z-10">
                <div className="text-6xl px-1 font-black text-transparent bg-clip-text bg-gradient-to-br from-slate-900 to-slate-600 mb-2 leading-none">
